...
Run:  python scripts/build_policy.py   (or via: python scripts/seed_testing.py)
Out:  backend/storage/clients/client_0/policy.pdf
...
# Output straight into the mock client's folder (the unified per-client storage).
OUT = os.path.normpath(os.path.join(_ROOT, "backend", "storage", "clients", "client_0", "policy.pdf"))
